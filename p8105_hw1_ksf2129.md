...
Variables include the “origin” (weather station/airport), year, month
(with 1 denoting January), day, hour (starting with 0 and going to 23),
“temp” (temperature in Fahrenheit), “dewp” (dewpoint in Fahreinheit),
“humid” (relative humidity), “wind_dir” (wind direction in degrees),
“wind_speed” (wind speed in miles per hour), “wind_gust” (gust speed in
miles per hour), “precip” (precipitation in inches), “pressure” (sea
...
of January. The temperture seems to rise and fall throughout the day
each day. The maximum value this cycle reaches is steadily increasing
from the beginning to the middle of the month. Additionally, the
humidiity is generally low for a majority of the time_hour period, but
